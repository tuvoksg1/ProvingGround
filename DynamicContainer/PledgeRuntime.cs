...
namespace DynamicContainer
{
    ...
    /// </summary>
    /// <seealso cref="CXUtils.Serialization.DataXmlSerializer{PledgeRuntime}" />
    /// <seealso cref="IConfigurationSectionHandler" />
    public class PledgeRuntime : DataXmlSerializer<PledgeRuntime>, IConfigurationSectionHandler
    {
        /// <summary>
